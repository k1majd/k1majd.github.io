...
---
<div class="mb-5">
    <h2 style="text-align:center " id="center" class="text-3xl w-full font-bold ">Kinematic-based Trajectory Planning Framework for Autonomous Ground Vehicles</h2>
  </div>
<div class="mb-5">
...
<div class="center">
    <div id="col_inner_id-638fba18b86c0" class="fw-col-inner" data-paddings="0px 0px 0px 0px">
		<a href="/papers/IEEE_JAS19.pdf" target="_blank" id="button_35873d1d8b5611a5c514ec3437e68163" class="btn btn-outline" data-mtop="0" data-mbottom="0">Full Paper (IEEE-JAS)</a>
    <a href="/papers/IV18.pdf" target="_blank" id="button_35873d1d8b5611a5c514ec3437e68163" class="btn btn-outline" data-mtop="0" data-mbottom="0">Full Paper (IV)</a>
    </div>
</div>
</div>
<br />
<br />
  ...
  <div class="pub-row">
    <div class="pub-badge"><span class="badge">JAS'19</span></div>
    <div class="pub-content">
      <h3 class="font-semibold mb-0.2 text-justify">A stable analytical solution method for car-like robot trajectory tracking and optimization</h3>
      <p class="font-light text-sm"><ins>K. Majd</ins>, M. Razeghi-Jahromi, and A. Homaifar</p>
  ...
  <div class="pub-row">
    <div class="pub-badge"><span class="badge">IV'18</span></div>
    <div class="pub-content">
      <h3 class="font-semibold mb-0.2 text-justify">Optimal Kinematic-based Trajectory Planning and Tracking Control of Autonomous Ground Vehicle Using the Variational Approach</h3>
      <p class="font-light text-sm"><ins>K. Majd</ins>, M. Razeghi-Jahromi, and A. Homaifar</p>
      <i class="font-light text-sm">IEEE Intelligent Vehicles Symposium (IV), 2018.</i>
